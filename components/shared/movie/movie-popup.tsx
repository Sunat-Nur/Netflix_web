...
import {VisuallyHidden} from "@radix-ui/react-visually-hidden"; // Ensure you have this component
                    ...
                    <>
                        ...
                        <div className={"flex flex-col space-y-4"}>
                            ...
                            <div className={"flex flex-row items-center flex-wrap gap-2"}>
                                <ReactStars value={movieDetails?.vote_average} count={10} edit={false}
                                            color2={"#e5b109"}/>
                                <p className={"text-[#e5b109]"}>({movieDetails?.vote_count})</p>
                                <span className={"text-green-400 font-semibold"}>
                                    {movieDetails?.release_date ? movieDetails?.release_date.split("-")[0] : "2023"}
                                </span>
                                <div
                                    className="inline-flex border-2 border-white/40 text-green-400 font-semibold rounded px-2">
                                    HD
                                </div>
                            </div>
                        </div>
